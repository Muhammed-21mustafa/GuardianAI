...
export default function Dashboard() {
  ...
  const [customerClaim, setCustomerClaim] = useState<string>("");
  ...
  const handleAnalyze = async () => {
    ...
    setError(null);
    try {
      const data = await analyzeReturn(originalImage, returnedImage, customerClaim);
      setResult(data);
    } catch (err: any) {
        ...
        {!result && (
          <section className="bg-[#0c0c0e] border border-zinc-800 rounded-xl p-6 shadow-xl max-w-4xl mx-auto mt-10">
            ...
            <div className="mt-8 border-t border-zinc-800 pt-6">
              <label className="text-xs font-semibold text-zinc-400 uppercase tracking-wider block mb-2">Customer's Stated Reason (Claim)</label>
              <select 
                value={customerClaim}
              ...
              >
                ...
                <option value="Product was defective or didn't work">Product was defective or didn't work</option>
                <option value="Wrong item was sent">Wrong item was sent</option>
                <option value="Item arrived damaged">Item arrived damaged</option>
                <option value="Changed my mind / Didn't like it">Changed my mind / Didn't like it</option>
            ...
            <div className="mt-8 flex justify-end">
              <button onClick={handleAnalyze} disabled={!originalImage || !returnedImage || loading}
                className={`px-6 py-2.5 rounded-md font-medium text-sm flex items-center gap-2 transition-all ${(!originalImage || !returnedImage || loading) ? 'bg-zinc-800 text-zinc-500 cursor-not-allowed' : 'bg-white text-black hover:bg-zinc-200 shadow-[0_0_20px_rgba(255,255,255,0.1)]'}`}>
